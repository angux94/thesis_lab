...
int main(int argc, char** argv)
{
  ...
  start_name[1].data = "door_1";
  start_name[2].data = "door_2";
  start_name[3].data = "seat_1";
  start_name[4].data = "seat_2";


  final_name[0].data = "home";
  final_name[1].data = "door_1";
  final_name[2].data = "door_2";
  final_name[3].data = "seat_1";
  final_name[4].data = "seat_2";
  ...
  points[0][3] = 0.2061;
  points[0][4] = 1.5631;
  points[0][5] = -0.00698132;

  //door_1
  points[1][0] = -0.3915; //-0.7049;
  points[1][1] = -0.4053; //-1.1981;
  points[1][2] = 0.7602; //1.6260;
  points[1][3] = -1.9794; //-1.4598;
  points[1][4] = 1.6488; //0.5285;
  points[1][5] = 1.2789; //1.0093;

  //door_2
  points[2][0] = -0.4245; // -0.7052;
  points[2][1] = -0.9263; // -1.6972;
  points[2][2] = 1.7180; // 1.9266;
  points[2][3] = -2.2628; // -0.2927;
  points[2][4] = 1.6489; // -0.0038;
  points[2][5] = 1.2789; // 1.0093;

  //seat_1
  points[3][0] = 1.8596; // 1.5790;
  points[3][1] = -0.7896; // -1.6432;
  points[3][2] = 1.6217; // 1.8536;
  points[3][3] = -2.1693; // 0.3076;
  points[3][4] = 1.6487; // 1.4263;
  points[3][5] = 1.2789;// 1.5521;

  //seat_2
  points[4][0] = 1.8722; // 2.0299;
  points[4][1] = -0.2958; // -0.9607;
  points[4][2] = 0.8744; // 1.3326;
  points[4][3] = -2.1691; // -1.471;
  points[4][4] = 1.6487; // 1.9863;
  points[4][5] = 1.2789; // 2.1216;
